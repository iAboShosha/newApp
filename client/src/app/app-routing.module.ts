...
const routes: Routes = [
    ...
    { path: 'contactses/:id',  loadChildren: './pages/contacts-edit/contacts-edit.module#ContactsEditModule' , canActivate: [AuthGuard] },
    { path: 'contactses',  loadChildren: './pages/contacts-list/contacts-list.module#ContactsListModule' , canActivate: [AuthGuard] },
